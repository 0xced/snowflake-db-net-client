...
public class BrowserAuthenticatorSettings : SnowflakeClientSettings
{
    ...
    public BrowserAuthenticatorSettings(TokenWebServer webServer, AuthInfo authInfo, SessionInfo? sessionInfo = null, UrlInfo? urlInfo = null,
    ...
    {
        _authenticator = new BrowserAuthenticator(webServer, UrlInfo);
    }
